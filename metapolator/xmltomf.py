...
# testing new center points
    ...
    mean = ['265','180','192','148', '159','198', '232', '136', '138', '244', '243', '249', '175', '200', '205', '151', '250', '255', '162', '216', '215', '213', '262', '268', '220', '150']
...
#            zeile = zeile + " shifted (" + str(pointshiftedval[i]) + ")"
            ...
            zeile = zeile + " shifted ((((" + str(pointshiftedval[i]) + ") + metapolation * ((" + str(B_pointshiftedval[i]) + ") - (" + str(pointshiftedval[i]) + "))) + ((" + str(C_pointshiftedval[i]) + ") + metapolationCD * ((" + str(D_pointshiftedval[i]) + ") - (" + str(C_pointshiftedval[i]) + ")))) /divider)"
...
#                                tensionandval2C, tensionandval2D)
                ...
                zeile = zeile + strtwo + " {dir (((" + str(dir2val[i]) + " + metapolation * (" + str(dir2valB[i]) + " - " + str(dir2val[i]) + ")) + (" + str(dir2valC[i]) + " + metapolationCD * (" + str(dir2valD[i]) + " - " + str(dir2valC[i]) + "))) /divider)}"

#        if upp2[i] != "":
#            zeile += dash + upp2[i]
            elif dir2[i] != "":
#            set_value_for_index(i, dir2val, dir2valB, dir2valC, dir2valD)
                zeile = zeile + " ... {dir (((" + str(dir2val[i]) + " + metapolation * (" + str(dir2valB[i]) + " - " + str(dir2val[i]) + ")) + (" + str(dir2valC[i]) + " + metapolationCD * (" + str(dir2valD[i]) + " - " + str(dir2valC[i]) + "))) /divider)}"
